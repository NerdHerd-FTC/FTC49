...
public class ArmControlDriverOriented extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        DcMotor motorTB = hardwareMap.dcMotor.get("topBottom");
        ...
        // Top Bottom Motor move forward
        motorTB.setDirection(DcMotorSimple.Direction.FORWARD);
        ...
        while (opModeIsActive()) {
            ...
            double right_trigger = gamepad1.right_trigger; // Up
            double left_trigger = gamepad2.left_trigger; // Down
            ...
            double TBPower = (right_trigger + left_trigger) / denominator;
